...
public class ModBlocks {
    ...
    //public static final Block SCULK_SNIFFER_EGG = new SnifferEggBlock(AbstractBlock.Settings.of(Material.EGG,MapColor.DARK_AQUA).strength(0.5F).sounds(BlockSoundGroup.METAL).ticksRandomly().nonOpaque(), ModEntities.SCULK_SNIFFER);
    ...
    public static void init(){
        ...
        //addBlock("sculk_sniffer_egg",SCULK_SNIFFER_EGG);
